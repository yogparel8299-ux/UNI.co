...
export default function Page() {
  return (
    <AppShell title="Billing" eyebrow="Credits and plans">
      ...
      <section className="mt-3 grid gap-3 xl:grid-cols-[1.2fr_.8fr]">
        <Card className="min-h-[420px]">
          <p className="mb-3 text-[11.5px] font-medium text-blue-500">Credits and plans</p>
          <h2 className="max-w-md text-[1.75rem] font-medium leading-[1.15] tracking-tight text-gray-900">Billing</h2>
          <p className="mt-3 max-w-sm text-[13px] text-gray-400">Track credits, subscriptions, payments, invoices and usage.</p>
