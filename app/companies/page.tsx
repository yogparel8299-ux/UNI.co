...
export default function Page() {
  return (
    <AppShell title="Companies" eyebrow="Workspace control">
      ...
      <section className="mt-3 grid gap-3 xl:grid-cols-[1.2fr_.8fr]">
        <Card className="min-h-[420px]">
          ...
          <h2 className="max-w-md text-[1.75rem] font-medium leading-[1.15] tracking-tight text-gray-900">Companies</h2>
          <p className="mt-3 max-w-sm text-[13px] text-gray-400">Manage company profiles, operating units, workspaces and ownership structure.</p>
