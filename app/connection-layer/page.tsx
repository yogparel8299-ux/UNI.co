...
export default function Page() {
  return (
    <AppShell title="Connection layer" eyebrow="Connected tools">
      ...
      <section className="mt-3 grid gap-3 xl:grid-cols-[1.2fr_.8fr]">
        <Card className="min-h-[420px]">
          <p className="mb-3 text-[11.5px] font-medium text-blue-500">Connected tools</p>
          <h2 className="max-w-md text-[1.75rem] font-medium leading-[1.15] tracking-tight text-gray-900">Connection layer</h2>
          <p className="mt-3 max-w-sm text-[13px] text-gray-400">Connect Gmail, Slack, GitHub, Notion and operational business apps.</p>
