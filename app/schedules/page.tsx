...
export default function Page() {
  return (
    <AppShell title="Schedules" eyebrow="Automation timing">
      ...
      <section className="mt-3 grid gap-3 xl:grid-cols-[1.2fr_.8fr]">
        <Card className="min-h-[420px]">
          <p className="mb-3 text-[11.5px] font-medium text-blue-500">Automation timing</p>
          <h2 className="max-w-md text-[1.75rem] font-medium leading-[1.15] tracking-tight text-gray-900">Schedules</h2>
          <p className="mt-3 max-w-sm text-[13px] text-gray-400">Create recurring agent tasks, workflow triggers and scheduled company operations.</p>
